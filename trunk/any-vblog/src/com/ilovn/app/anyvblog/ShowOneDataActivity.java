...
import com.ilovn.app.anyvblog.location.StaticMap;
import com.ilovn.app.anyvblog.model.Counts;
import com.ilovn.app.anyvblog.model.DataAdapter;
import com.ilovn.app.anyvblog.model.SendCounts;
import com.ilovn.app.anyvblog.model.SendData;
import com.ilovn.app.anyvblog.model.UserAdapter;
import com.ilovn.app.anyvblog.model.netease.SendGetOne4Netease;
import com.ilovn.app.anyvblog.model.netease.Status4Netease;
import com.ilovn.app.anyvblog.model.sina.Counts4Sina;
import com.ilovn.app.anyvblog.model.sina.SendGetOne4Sina;
import com.ilovn.app.anyvblog.model.sina.Status4Sina;
import com.ilovn.app.anyvblog.model.sohu.Counts4Sohu;
import com.ilovn.app.anyvblog.model.sohu.SendGetOne4Sohu;
import com.ilovn.app.anyvblog.model.sohu.Status4Sohu;
import com.ilovn.app.anyvblog.model.tencent.GetOneData4Tencent;
import com.ilovn.app.anyvblog.model.tencent.SendGetOne4Tencent;
import com.ilovn.app.anyvblog.utils.Config;
import com.ilovn.app.anyvblog.utils.Constants;
import com.ilovn.app.anyvblog.utils.MapsUtils;
		...
		if (adapter != null) {
			...
			if (adapter.getImage_m() != null) {
				...
				show_one_image.asyncLoadBitmapFromUrl(adapter.getImage_m(),
						Config.cachePath + adapter.getImage_m().substring(adapter.getImage_m().length() - 12).replace("/", "_") + ".jpg");
				...
				if (adapter.getSource_image_m() != null) {
					...
					source_show_one_image.asyncLoadBitmapFromUrl(
							adapter.getSource_image_m(), Config.cachePath
									+ adapter.getSource_image_m().substring(adapter.getSource_image_m().length() - 12).replace("/", "_") + ".jpg");
