 ...
 *
 */
public class SendNoUpdateAsyncTask extends AsyncTask<Void, Void, Response> {
	private static final String TAG = "SendNoUpdateAsyncTask";
	...
	public SendNoUpdateAsyncTask(Context context, SendData sendData, String url,
	...
	protected void onPostExecute(Response result) {
		...
		message.what = MyHandler.Handler_GetData_Without_Update;
