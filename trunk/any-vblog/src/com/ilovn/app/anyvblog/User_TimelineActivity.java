...
import com.ilovn.app.anyvblog.model.netease.SendUserTimeLineData4Netease;
import com.ilovn.app.anyvblog.model.netease.Status4Netease;
import com.ilovn.app.anyvblog.model.sina.SendUserTimeLineData4Sina;
...
import com.ilovn.app.anyvblog.model.tencent.SendUserTimeLineData4Tencent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		timeline.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
					int position, long id) {
				if (position == ListView.INVALID_POSITION || position > datas.size()) {
					return;
				}
				Intent intent = new Intent(activity, ShowOneDataActivity.class);
				intent.putExtra("id", datas.get(position - 1).getStatus_id());
