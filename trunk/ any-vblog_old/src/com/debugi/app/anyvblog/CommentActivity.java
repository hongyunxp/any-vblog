...
import com.debugi.app.anyvblog.asynctask.SendCommentAsyncTask;
...
import com.debugi.app.anyvblog.model.netease.SendComment4Netease;
import com.debugi.app.anyvblog.model.sina.SendComment4Sina;
import com.debugi.app.anyvblog.model.sohu.SendComment4Sohu;
import com.debugi.app.anyvblog.model.tencent.SendComment4Tencent;
		...
		case R.id.write_send:
			...
			if (!isChecked) {
				...
				if (count < 0) {
					...
					Toast.makeText(activity, "内容被截断", Toast.LENGTH_SHORT)
							.show();
				}
				// 启动异步任务发送数据
