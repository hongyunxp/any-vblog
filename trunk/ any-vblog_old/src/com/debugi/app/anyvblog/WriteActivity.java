...
import com.debugi.app.anyvblog.asynctask.SendDataAsyncTask;
import com.debugi.app.anyvblog.db.DataHelper;
import com.debugi.app.anyvblog.location.LocationModel;
import com.debugi.app.anyvblog.location.LocationService;
...
public class WriteActivity extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.write_topic:
			...
			break;
		case R.id.write_pic:
			Toast.makeText(activity, "暂不支持该功能", Toast.LENGTH_SHORT).show();
			break;
		case R.id.write_at:
			Toast.makeText(activity, "暂不支持该功能", Toast.LENGTH_SHORT).show();
			break;
