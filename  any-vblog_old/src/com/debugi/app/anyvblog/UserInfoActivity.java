...
import com.debugi.app.anyvblog.model.netease.SendFriend4Netease;
...
import com.debugi.app.anyvblog.model.sina.Friendships4Sina;
...
import com.debugi.app.anyvblog.model.tencent.SendFriend4Tencent;
	...
	private void fillData() {
		...
		if (user.getSp() != Constants.SP_SINA) {
			...
			new Thread(new Runnable() {
				...
				@Override
				public void run() {
					OAuthRequest request = new OAuthRequest(HttpType.GET, Constants.Sina.FRIENDSHIPS);
					request.addQuerystringParameter("target_id", user_id);
					OAuthServiceProvider serviceProvider = new OauthModel4Sina().getServiceProvider();
					...
					Config.debug(TAG, res.getBody());
					Friendships4Sina friendships4Sina = gson.fromJson(res.getBody(), Friendships4Sina.class);
