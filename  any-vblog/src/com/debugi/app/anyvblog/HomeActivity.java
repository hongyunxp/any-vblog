...
import com.debugi.app.anyvblog.adapter.HomeAccountSpAdapter;
...
import com.debugi.app.anyvblog.asynctask.GetHomeTimeLineFromDBAsyncTask;
...
import com.debugi.app.anyvblog.model.netease.SendHomeTimeLineData4Netease;
import com.debugi.app.anyvblog.model.netease.Status4Netease;
import com.debugi.app.anyvblog.model.sina.SendHomeTimeLineData4Sina;
...
import com.debugi.app.anyvblog.model.tencent.SendHomeTimeLineData4Tencent;
			...
			case Constants.SP_TENCENT:
				...
				if (data4Tencent.getRet() == 0) {
					...
					if (data4Tencent.getData().getHasnext() == 1) {
						home_timeline.onClickComplete(R.string.footer_no_more_data);
					}
				}
				break;
				...
				case MyHandler.Handler_GetData:
					...
					try {
						...
						if (type == 0) {
							...
							fillData(datas);
							saveData(datas, type);
							home_timeline.onClickComplete(R.string.footer_normal_tips);
						} else {
		...
		home_timeline.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (isUserChange) {
					...
					Toast.makeText(activity, "用户已经切换，不能现在获取微博信息，请等候列表更新……",
